...
const Spillespill: React.FC = () => {
  const content = (
    <>
      <p>
        Det var kanskje ikke så lurt å trykke på den lenken? Du trodde kanskje
        du skulle til spillespill, men slike lenker kan være nok til å gi deg
  ...
  return (
    <div>
      ...
      <ImageContent title="" src="/Sad-Face.png" alt="Sad-Face" />
    </div>
  );
};
