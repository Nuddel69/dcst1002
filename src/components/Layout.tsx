  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { title: "Pharming", link: "/svindelteknikker/pharming" },
        {
          ...
          link: "/svindelteknikker/social-engineering",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          title: "Hvorfor kan noen lenker være farlige?",
          link: "/lenker/farlige-lenker",
        },
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          title: "Hva gjør du hvis noen får tak i passordet ditt?",
          link: "/passord/mistet",
        },
        {
          title: "Hvordan holder jeg passordene mine trygge?",
          link: "/passord/trygge",
        },
      ],
    },
